...
const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <Link to="/" className="absolute top-6 left-6 flex items-center gap-3 hover:opacity-80 transition-opacity z-20">
      ...
      <div className="bg-gray-800 border border-gray-700 p-6 md:p-8 rounded-3xl shadow-2xl w-full max-w-lg relative">
        ...
        <p className="text-center text-gray-500 mt-8 text-sm">
            Já tem uma conta? <Link to="/login" className="text-indigo-400 hover:text-indigo-300 font-semibold hover:underline transition-all">Fazer Login</Link>
        </p>
      </div>
    </div>
  );
