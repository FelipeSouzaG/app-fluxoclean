      ...
      <div className="bg-gray-800 border border-gray-700 p-6 md:p-8 rounded-2xl shadow-2xl w-full max-w-md">
        ...
        {submitted ? (
            <div className="text-center space-y-6 animate-fade-in">
                ...
                <button onClick={() => navigate('/login')} className="text-indigo-400 hover:text-indigo-300 font-medium transition-colors hover:underline">
                    Voltar para o Login
                </button>
            </div>
        ) : (
            ...
            <div className="text-center">
                <Link to="/login" className="text-sm text-gray-400 hover:text-white transition-colors">Cancelar e voltar</Link>
            </div>
            </form>
        )}
      </div>
